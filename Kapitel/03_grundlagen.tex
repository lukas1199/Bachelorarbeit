...
In den 1990er-Jahren wurde durch Gouillart und Kelly das Modell der "vier R der Transformation" entwickelt, was eine mögliche Form der Business Transformation darstellen soll. Aus diesem Modell hat die Beratungsgesellschaft Gemini Consulting (später in der Capgemini SE aufgegangen \footcite[Vgl.][]{gemini-died})
\begin{figure}[h]
    \centering
