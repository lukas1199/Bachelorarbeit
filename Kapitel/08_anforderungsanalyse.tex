...
\subsection{Akteure des IT-Systems}
...
\begin{itemize}
    ...
    \item[] \underline{Kunde:} Der Administrator wird in den Anforderungen \emph{/F21/} bis \emph{/F23/} beschrieben und verwaltet das System, indem er Benutzer anlegt, ihnen Rollen zuweist, Projekte erstellt und verwaltet. Er kann außerdem alle Projekte und darin enthaltenen Teilprojekte einsehen und Änderungen vornehmen. Verkörpert wird der Administrator durch die Mitarbeiter des oberen Managements des auftraggebenen Unternehmen.
